...
;/**
* Data Grid Table
* 1) When checking a table row, input errors in red appear.
*/

(function(){
    var inputs = document.querySelectorAll('.em-js-cell-checkbox');
    var checkboxes = [];
    ...
    for (var j = 0; j < checkboxes.length; j++) {
        checkboxes[j].onclick = function() {
            if (this.checked == true) {
                ...
                removeClassName(this.parentNode.parentNode.parentNode, 'selected');
            }
        }
    }
